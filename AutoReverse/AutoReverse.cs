...
namespace HTAutoReverse
{
    ...
    public class AutoReverse : BaseUnityPlugin
    {
        ...
        static class Patch
        {
            ...
            [HarmonyPostfix, HarmonyPatch(typeof(BuildTool_Path), "UpdatePreviewModelConditions")]
            public static void BuildTool_Path_UpdatePreviewModelConditions_Postfix(BuildTool_Path __instance)
            {
            ...
            [HarmonyPrefix, HarmonyPatch(typeof(BuildTool_Path), "CreatePrebuilds")]
